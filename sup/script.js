...
reset.addEventListener("click", () => {
    if (confirm("Akan memulali ulang game, Anda yakin?")) {
        skorKen = 0;
        skorPlayer = 0;
        displaySkorKen.innerHTML = skorKen;
        displaySkorPlayer.innerHTML= skorPlayer;
...
function janken(tangan) {
    ...
    switch (jariKen) {
        case 0:
            ken.style.backgroundImage = "url(sup/ken-batu.png)";
            break;
        case 1:
            ken.style.backgroundImage = "url(sup/ken-gunting.png)";
            break;
        default:
            ken.style.backgroundImage = "url(sup/ken-kertas.png)";
            break;
    }
